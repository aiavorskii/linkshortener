...
(function ($) {
  ...
  $('#link-form').on('submit', function (e) {
    e.preventDefault();
    var formData = new FormData(document.querySelector('#link-form'));
    axios__WEBPACK_IMPORTED_MODULE_1___default().post('/link-create', Object.fromEntries(formData)).then(function (response) {
      // open modal
